...
%DB = adodb_connect('Provider=Microsoft.Jet.OLEDB.4.0; Data Source=ArDataSQL;PERSIST SECURITY INFO = False');
DB = adodb_connect('Provider=SQLOLEDB;Data Source=CPSOBOL\ARDATA;Initial Catalog=ArDataSQL;User Id=geouser;Password=geology;');
...
record6 = adodb_query(DB, 'select * from tblPrepData');
disp(record6)
